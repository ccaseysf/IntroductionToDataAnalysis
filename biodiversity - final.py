...
category_value = species.groupby('category').category.nunique()
category_value
...
conservation_status_value = species.groupby('conservation_status').conservation_status.count()
...
conservation_status_counts = species.groupby('conservation_status').scientific_name.nunique()
...
Baseline 15%
Minimum detectable Effect 100*(0.05/0.15) = 33%
...
Number of weeks at Bryce = 2.08
Number of weeks at Yellowstone = 1.03
